...
-- Source unique : apps/web/src/import/regles.ts (REGLES_INITIALES).
...
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('06b0ca81-5490-4522-80f6-5b40e08c1412', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'ALDI', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('eb044ba0-e960-4026-8b29-d46547fec10c', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'E.LECLERC', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('325c7451-1b14-4294-840e-4d709cec9715', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'LECLERC', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('0c5ae141-cc0d-4c05-897f-d868a1222510', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'AUCHAN', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('62b4373f-4330-4218-818c-a5e4e63c281c', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'MONOPRIX', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('a5e2e94f-0382-4a66-8587-a9658f1af1a8', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'FRANPRIX', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('262c752c-fe81-4d8a-8a57-24ae153a7285', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'CASINO', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('e673e532-08d0-4eea-8532-ef4461c6b35b', :uid, '9378554a-5a1e-4c96-801e-ed96e918ba68', 'PICARD', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
...
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('0ef2c759-006e-40e9-85b9-0f61a8a42cd8', :uid, '21be9124-2ca4-40d1-8775-4e637e92653b', 'FREE MOBILE', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('50f61c2a-4f44-41fb-814b-a03a6ff8f2e2', :uid, '21be9124-2ca4-40d1-8775-4e637e92653b', 'SOSH', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('813bf605-5094-4d1a-80b6-d1d0f05283b3', :uid, '21be9124-2ca4-40d1-8775-4e637e92653b', 'ORANGE', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('8700de9c-c786-4408-89c7-4e878b689502', :uid, '21be9124-2ca4-40d1-8775-4e637e92653b', 'SFR', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
...
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('57e00bf3-8f70-4d89-8d48-e75024bc07a0', :uid, 'bde44515-6e85-4d36-8357-2c69aebc39ac', 'ENGIE', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
...
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('c319a6a9-1a5a-4d94-841a-dd749c04494c', :uid, '166c2382-489d-45ef-8136-5f094a024344', 'ESSO', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('ab3803b3-32b6-4998-8694-ddee4afc01a8', :uid, '166c2382-489d-45ef-8136-5f094a024344', 'SHELL', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('cb496f9d-57db-49c9-80c2-2324aa6261dc', :uid, '166c2382-489d-45ef-8136-5f094a024344', 'STATION BP', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('c6f81be2-5a7f-49c8-8018-2177f2f454e8', :uid, '166c2382-489d-45ef-8136-5f094a024344', 'AVIA', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
...
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('cb61cb15-c713-40c7-89ce-927529f66225', :uid, 'b80ae10d-dc43-4644-887b-944ec2f22820', 'DOCTOLIB', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
...
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('91bb27d9-fcd4-46d6-8a72-8e8f8ba4b531', :uid, 'e7391cf9-2831-4cf0-873c-0f6a3460b5ab', 'NETFLIX', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
insert into public.categorization_rules (id, user_id, category_id, pattern, match_type, priority, auto_validate, is_active) values ('120c45e7-38b1-42ab-8634-4abde4e63624', :uid, 'e7391cf9-2831-4cf0-873c-0f6a3460b5ab', 'SPOTIFY', 'contains', 100, false, true) on conflict (id) do update set pattern = excluded.pattern;
